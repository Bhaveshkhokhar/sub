...
export default function ProfileScreen() {
  ...
  const { friendId, friendName, friendImage } = params;
            ...
            <View style={styles.profileHeader}>
              <View style={styles.avatarContainer}>
                <View style={styles.avatarGradient}>
                  <View style={styles.avatarWrapper}>
                    <Image
                      source={{ 
                        uri: friendProfile.info?.dp || friendImage as string || 'https://images.pexels.com/photos/771742/pexels-photo-771742.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&dpr=2'
                      }}
                      style={styles.avatar}
              ...
              <View style={styles.profileInfo}>
                <Text style={styles.profileName}>
                  {friendProfile.info?.fullname || friendName || 'Unknown User'}
                </Text>
