...
export default function ConversationScreen() {
  ...
  const handleProfilePress = () => {
    ...
    if (chatDetails?.type === 'private') {
      router.push({
        ...
        params: {
          friendId: chatDetails?.whatsub_room_user_mappings[0]?.id,
          friendName: String(chatDetails?.whatsub_room_user_mappings[0]?.auth_fullname),
          friendImage: chatDetails?.room_dp,
        },
      });
    }
  ...
  return (
    ...
    >
          ...
          <View style={styles.headerText}>
            <Text style={styles.headerName} numberOfLines={1}>
              {chatDetails?.type === "group"
                ...
                : (String(chatDetails?.whatsub_room_user_mappings?.[0]?.auth_fullname) || "User")}
                  ...
                  {message.type === "event" ? (
                    ...
                    >
                      <View style={styles.messageBubbleContainer}>
                        ...
                        >
                          {message.from_user_id !== userId ? <Text style={styles.senderName}>{message.from_user_fullname.fullname}</Text> : ''}
                          <Text
                            style={[
                              styles.messageText,
      ...
      {
        paddingBottom: isKeyboardVisible ? 30 : 20,
